...
model = keras.models.load_model('../../models/pretrained/xception-lite.h5')
model.summary()
...
def train(model, train_dataset, validation_dataset, epochs):
	...
	history.to_csv('../../history/fineTuned/xception-lite.csv', encoding='utf-8', index=False) 

	#Save model
	model.save('../../models/fineTuned/xception-lite.h5')
