...
model = keras.models.load_model('../../CALTECH101/models/xception-lite.h5')
model.summary()
...
def train(model, train_dataset, validation_dataset, epochs):
	...
	history.to_csv('../history/pretrained/xception-lite.csv', encoding='utf-8', index=False) 

	#Save model
	model.save('../models/pretrained/xception-lite.h5')
