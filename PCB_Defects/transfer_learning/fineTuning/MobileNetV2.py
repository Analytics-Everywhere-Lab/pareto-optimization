...
model = keras.models.load_model('../../models/pretrained/mobilenet.h5')
model.summary()
...
def train(model, train_dataset, validation_dataset, epochs):
	...
	history.to_csv('../../history/fineTuned/mobilenet.csv', encoding='utf-8', index=False) 

	#Save model
	model.save('../../models/fineTuned/mobilenet.h5')
