...
model = keras.models.load_model('../../CALTECH101/models/efficientnet.h5')
model.summary()
...
def train(model, train_dataset, validation_dataset, epochs):
	...
	history.to_csv('../history/pretrained/efficientnet.csv', encoding='utf-8', index=False) 

	#Save model
	model.save('../models/pretrained/efficientnet.h5')
